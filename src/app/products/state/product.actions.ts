...
export class ClearCurrentProduct implements Action {
  ...
  //no constructor defined (typescript still provides default no arg constructor) b/c no payload
}
...
export class UpdateProductFail implements Action {
  ...
  constructor(public payload: string) {} //string holds error message
}
